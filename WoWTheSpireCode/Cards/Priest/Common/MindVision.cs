...
public class MindVision() : PriestCard(1, CardType.Skill, CardRarity.Common, TargetType.AnyEnemy) {
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay play) {
        ...
        if (play.Target.Monster.NextMove.Intents.All(intent => {
                return intent.IntentType switch {
                    IntentType.Attack => false,
                    _ => true
                };
